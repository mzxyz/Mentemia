...
const mapStateToFeaturedProps = ({ explore: { featuredList } }: State) => ({
	type: 'featured',
	dataList: featuredList,
});

const mapStateToExploreProps = ({ explore: { exploreList } }: State) => ({
	type: 'explore',
	dataList: exploreList,
});

const mapStateToFavoriteProps = ({ explore: { favoriteList } }: State) => ({
	type: 'favorite',
...
export const FeaturedContainer = connect(mapStateToFeaturedProps, mapDispatchToProps)(ExplorePage);

export const ExploreContainer = connect(mapStateToExploreProps, mapDispatchToProps)(ExplorePage);

export const FavoriteContainer = connect(mapStateToFavoriteProps, mapDispatchToProps)(ExplorePage);
